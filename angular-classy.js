...
(function() {
  ...
  classFns = {
    construct: function(parent, args) {
      ...
      if (typeof (_base = parent.init || parent.initialize) === "function") {
        _base();
      }
    ...
    addFnsToScope: function(parent) {
      ...
      for (key in _ref) {
        ...
        _results.push(parent.$scope[key] = parent.constructor.prototype[key] = angular.bind(parent, fn));
      }
      return _results;
    },
    ...
    */
    ...
    if (reqs && __indexOf.call(reqs, 'classy') >= 0) {
      classyController = (function() {
        classyController.register = function(name, deps, newModule) {
          return classFns.register(newModule || module, name, deps, this);
        };

        classyController.create = function(name, deps, proto) {
          return classFns.create(appInstance, name, deps, proto, this);
        };
